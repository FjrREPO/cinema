...
const SearchCard = ({ movie }: SearchCardProps) => {
    return (
        <>
            <div className="">
                <div className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row max-w-[60vw] hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    {movie.poster_path ? (
