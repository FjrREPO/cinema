                            ...
                            <div className="flex items-start">
                                <div className="w-[15vw]">
                                    <div className="flex items-center w-full">
                                        <div className="w-8 h-8 shrink-0 mx-[-1px] bg-[#fff] p-1.5 flex items-center justify-center rounded-full">
                                            <span className="text-base text-black font-bold">1</span>
                                        </div>
                                        <div className="w-[10vw] h-[3px] mx-4 rounded-lg bg-[#fff]"></div>
                                    </div>
                                    <div className="mt-2 mr-4">
                                        <h6 className="text-base font-bold text-[#fff]">Shipping</h6>
                                    </div>
                                </div>
                                <div className="w-[15vw]">
                                    <div className="flex items-center w-full">
                                        ...
                                        <div className="w-[10vw] h-[3px] mx-4 rounded-lg bg-gray-300"></div>
                                    </div>
                                    <div className="mt-2 mr-4">
                                        <h6 className="text-base font-bold text-[#fff]">Billing</h6>
                                    </div>
                                </div>
                                <div>
