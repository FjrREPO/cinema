            ...
            <div className="flex items-center justify-center min-h-screen" style={{backgroundImage: 'url(https://unblast.com/wp-content/uploads/2021/01/Space-Background-Images.jpg)'}}>
                ...
                >
                    <div className="flex flex-col justify-center p-8 md:p-14">
                        ...
                        >
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/768px-Google_%22G%22_logo.svg.png" alt="img" className="w-6 h-6 inline mr-2" />
                            Sign in with Google
                        </button>
